// Generated by gencpp from file jetbotmini_msgs/SensorState.msg
// DO NOT EDIT!


#ifndef JETBOTMINI_MSGS_MESSAGE_SENSORSTATE_H
#define JETBOTMINI_MSGS_MESSAGE_SENSORSTATE_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::jetbotmini_msgs::SensorState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::jetbotmini_msgs::SensorState_<ContainerAllocator> const> ConstPtr;

}; // struct SensorState_

typedef ::jetbotmini_msgs::SensorState_<std::allocator<void> > SensorState;

typedef boost::shared_ptr< ::jetbotmini_msgs::SensorState > SensorStatePtr;
typedef boost::shared_ptr< ::jetbotmini_msgs::SensorState const> SensorStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::jetbotmini_msgs::SensorState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::jetbotmini_msgs::SensorState_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::jetbotmini_msgs::SensorState_<ContainerAllocator1> & lhs, const ::jetbotmini_msgs::SensorState_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::jetbotmini_msgs::SensorState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::jetbotmini_msgs::SensorState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::jetbotmini_msgs::SensorState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::jetbotmini_msgs::SensorState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::jetbotmini_msgs::SensorState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::jetbotmini_msgs::SensorState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::jetbotmini_msgs::SensorState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::jetbotmini_msgs::SensorState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x7250c1dc0b61c419ULL;
  static const uint64_t static_value2 = 0x0e78f528f599285fULL;
};

template<class ContainerAllocator>
struct DataType< ::jetbotmini_msgs::SensorState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::jetbotmini_msgs::SensorState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "########################################\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::jetbotmini_msgs::SensorState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::jetbotmini_msgs::SensorState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::jetbotmini_msgs::SensorState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // JETBOTMINI_MSGS_MESSAGE_SENSORSTATE_H
