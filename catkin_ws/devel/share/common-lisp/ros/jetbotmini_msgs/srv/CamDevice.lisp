...
(cl:defmethod cl:initialize-instance :after ((m <CamDevice-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CamDevice-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetbotmini_msgs-srv:<CamDevice-request> is deprecated: use jetbotmini_msgs-srv:CamDevice-request instead.")))

(cl:ensure-generic-function 'GetGev-val :lambda-list '(m))
(cl:defmethod GetGev-val ((m <CamDevice-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbotmini_msgs-srv:GetGev-val is deprecated.  Use jetbotmini_msgs-srv:GetGev instead.")
  (GetGev m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CamDevice-request>)))
  ...
  "jetbotmini_msgs/CamDeviceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CamDevice-request)))
  "Returns string type for a service object of type 'CamDevice-request"
  "jetbotmini_msgs/CamDeviceRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <CamDevice-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CamDevice-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetbotmini_msgs-srv:<CamDevice-response> is deprecated: use jetbotmini_msgs-srv:CamDevice-response instead.")))

(cl:ensure-generic-function 'camDevice-val :lambda-list '(m))
(cl:defmethod camDevice-val ((m <CamDevice-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbotmini_msgs-srv:camDevice-val is deprecated.  Use jetbotmini_msgs-srv:camDevice instead.")
  (camDevice m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CamDevice-response>)))
  ...
  "jetbotmini_msgs/CamDeviceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CamDevice-response)))
  "Returns string type for a service object of type 'CamDevice-response"
  "jetbotmini_msgs/CamDeviceResponse")
