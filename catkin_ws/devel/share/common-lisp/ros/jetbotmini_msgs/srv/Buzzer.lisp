...
(cl:defmethod cl:initialize-instance :after ((m <Buzzer-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Buzzer-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetbotmini_msgs-srv:<Buzzer-request> is deprecated: use jetbotmini_msgs-srv:Buzzer-request instead.")))

(cl:ensure-generic-function 'buzzer-val :lambda-list '(m))
(cl:defmethod buzzer-val ((m <Buzzer-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbotmini_msgs-srv:buzzer-val is deprecated.  Use jetbotmini_msgs-srv:buzzer instead.")
  (buzzer m))
...
(cl:defmethod cl:initialize-instance :after ((m <Buzzer-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Buzzer-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetbotmini_msgs-srv:<Buzzer-response> is deprecated: use jetbotmini_msgs-srv:Buzzer-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Buzzer-response>)))
  ...
  "jetbotmini_msgs/BuzzerResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Buzzer-response)))
  "Returns string type for a service object of type 'Buzzer-response"
  "jetbotmini_msgs/BuzzerResponse")
