...
(cl:defmethod cl:initialize-instance :after ((m <RobotArm-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotArm-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetbotmini_msgs-srv:<RobotArm-request> is deprecated: use jetbotmini_msgs-srv:RobotArm-request instead.")))

(cl:ensure-generic-function 'apply-val :lambda-list '(m))
(cl:defmethod apply-val ((m <RobotArm-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbotmini_msgs-srv:apply-val is deprecated.  Use jetbotmini_msgs-srv:apply instead.")
  (apply m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RobotArm-request>)))
  ...
  "jetbotmini_msgs/RobotArmRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RobotArm-request)))
  "Returns string type for a service object of type 'RobotArm-request"
  "jetbotmini_msgs/RobotArmRequest")
...
(cl:defclass <RobotArm-response> (roslisp-msg-protocol:ros-message)
  ((RobotArm
    :reader RobotArm
    :initarg :RobotArm
    :type jetbotmini_msgs-msg:Arm
    :initform (cl:make-instance 'jetbotmini_msgs-msg:Arm)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <RobotArm-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotArm-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetbotmini_msgs-srv:<RobotArm-response> is deprecated: use jetbotmini_msgs-srv:RobotArm-response instead.")))

(cl:ensure-generic-function 'RobotArm-val :lambda-list '(m))
(cl:defmethod RobotArm-val ((m <RobotArm-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbotmini_msgs-srv:RobotArm-val is deprecated.  Use jetbotmini_msgs-srv:RobotArm instead.")
  (RobotArm m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RobotArm-response>)))
  ...
  "jetbotmini_msgs/RobotArmResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RobotArm-response)))
  "Returns string type for a service object of type 'RobotArm-response"
  "jetbotmini_msgs/RobotArmResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RobotArm-response>)))
  ...
  (cl:format cl:nil "#response~%Arm RobotArm~%~%~%================================================================================~%MSG: jetbotmini_msgs/Arm~%Joint[] joint~%~%================================================================================~%MSG: jetbotmini_msgs/Joint~%int32 id~%int32 run_time~%float32 angle~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RobotArm-response)))
  "Returns full string definition for message of type 'RobotArm-response"
  (cl:format cl:nil "#response~%Arm RobotArm~%~%~%================================================================================~%MSG: jetbotmini_msgs/Arm~%Joint[] joint~%~%================================================================================~%MSG: jetbotmini_msgs/Joint~%int32 id~%int32 run_time~%float32 angle~%~%~%"))
