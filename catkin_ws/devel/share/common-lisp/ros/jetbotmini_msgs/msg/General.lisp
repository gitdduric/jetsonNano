...
(cl:defmethod cl:initialize-instance :after ((m <General>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'General)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetbotmini_msgs-msg:<General> is deprecated: use jetbotmini_msgs-msg:General instead.")))

(cl:ensure-generic-function 'Graphics-val :lambda-list '(m))
(cl:defmethod Graphics-val ((m <General>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbotmini_msgs-msg:Graphics-val is deprecated.  Use jetbotmini_msgs-msg:Graphics instead.")
  (Graphics m))

(cl:ensure-generic-function 'TrackState-val :lambda-list '(m))
(cl:defmethod TrackState-val ((m <General>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbotmini_msgs-msg:TrackState-val is deprecated.  Use jetbotmini_msgs-msg:TrackState instead.")
  (TrackState m))
