...
(cl:defmethod cl:initialize-instance :after ((m <Battery>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Battery)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetbotmini_msgs-msg:<Battery> is deprecated: use jetbotmini_msgs-msg:Battery instead.")))

(cl:ensure-generic-function 'Voltage-val :lambda-list '(m))
(cl:defmethod Voltage-val ((m <Battery>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbotmini_msgs-msg:Voltage-val is deprecated.  Use jetbotmini_msgs-msg:Voltage instead.")
  (Voltage m))
