...
(cl:defmethod cl:initialize-instance :after ((m <PWMServo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PWMServo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetbotmini_msgs-msg:<PWMServo> is deprecated: use jetbotmini_msgs-msg:PWMServo instead.")))
