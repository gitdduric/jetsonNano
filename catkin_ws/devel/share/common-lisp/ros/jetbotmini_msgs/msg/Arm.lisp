...
(cl:defclass <Arm> (roslisp-msg-protocol:ros-message)
  ((joint
    :reader joint
    :initarg :joint
    :type (cl:vector jetbotmini_msgs-msg:Joint)
   :initform (cl:make-array 0 :element-type 'jetbotmini_msgs-msg:Joint :initial-element (cl:make-instance 'jetbotmini_msgs-msg:Joint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Arm>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Arm)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetbotmini_msgs-msg:<Arm> is deprecated: use jetbotmini_msgs-msg:Arm instead.")))

(cl:ensure-generic-function 'joint-val :lambda-list '(m))
(cl:defmethod joint-val ((m <Arm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbotmini_msgs-msg:joint-val is deprecated.  Use jetbotmini_msgs-msg:joint instead.")
  (joint m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Arm>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'joint)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'jetbotmini_msgs-msg:Joint))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Arm>)))
  ...
  (cl:format cl:nil "Joint[] joint~%~%================================================================================~%MSG: jetbotmini_msgs/Joint~%int32 id~%int32 run_time~%float32 angle~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Arm)))
  "Returns full string definition for message of type 'Arm"
  (cl:format cl:nil "Joint[] joint~%~%================================================================================~%MSG: jetbotmini_msgs/Joint~%int32 id~%int32 run_time~%float32 angle~%~%~%"))
