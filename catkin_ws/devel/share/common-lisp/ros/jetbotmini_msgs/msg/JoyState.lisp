...
(cl:defmethod cl:initialize-instance :after ((m <JoyState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JoyState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetbotmini_msgs-msg:<JoyState> is deprecated: use jetbotmini_msgs-msg:JoyState instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <JoyState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbotmini_msgs-msg:state-val is deprecated.  Use jetbotmini_msgs-msg:state instead.")
  (state m))
