...
(cl:defmethod cl:initialize-instance :after ((m <LaserAvoid>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LaserAvoid)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetbotmini_msgs-msg:<LaserAvoid> is deprecated: use jetbotmini_msgs-msg:LaserAvoid instead.")))

(cl:ensure-generic-function 'Angle_range-val :lambda-list '(m))
(cl:defmethod Angle_range-val ((m <LaserAvoid>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbotmini_msgs-msg:Angle_range-val is deprecated.  Use jetbotmini_msgs-msg:Angle_range instead.")
  (Angle_range m))

(cl:ensure-generic-function 'ResponseDist-val :lambda-list '(m))
(cl:defmethod ResponseDist-val ((m <LaserAvoid>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbotmini_msgs-msg:ResponseDist-val is deprecated.  Use jetbotmini_msgs-msg:ResponseDist instead.")
  (ResponseDist m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <LaserAvoid>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbotmini_msgs-msg:speed-val is deprecated.  Use jetbotmini_msgs-msg:speed instead.")
  (speed m))
