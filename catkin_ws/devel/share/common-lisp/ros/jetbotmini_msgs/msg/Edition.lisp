...
(cl:defmethod cl:initialize-instance :after ((m <Edition>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Edition)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetbotmini_msgs-msg:<Edition> is deprecated: use jetbotmini_msgs-msg:Edition instead.")))

(cl:ensure-generic-function 'edition-val :lambda-list '(m))
(cl:defmethod edition-val ((m <Edition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbotmini_msgs-msg:edition-val is deprecated.  Use jetbotmini_msgs-msg:edition instead.")
  (edition m))
