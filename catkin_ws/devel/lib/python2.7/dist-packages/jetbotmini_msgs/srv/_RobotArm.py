...
"""autogenerated by genpy from jetbotmini_msgs/RobotArmRequest.msg. Do not edit."""
import codecs
import sys
...
class RobotArmRequest(genpy.Message):
  ...
  _type = "jetbotmini_msgs/RobotArmRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from jetbotmini_msgs/RobotArmResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
"""
  __slots__ = ['RobotArm']
  _slot_types = ['jetbotmini_msgs/Arm']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.RobotArm is None:
        self.RobotArm = jetbotmini_msgs.msg.Arm()
    else:
      self.RobotArm = jetbotmini_msgs.msg.Arm()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = jetbotmini_msgs.msg.Joint()
        _x = val1
        start = end
        end += 12
...
class RobotArm(object):
  _type          = 'jetbotmini_msgs/RobotArm'
